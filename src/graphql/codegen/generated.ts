...
export type GetCategorDetailQueryVariables = Exact<{
  categoryId?: Maybe<Scalars['Int']>
}>

export type GetCategorDetailQuery = { __typename?: 'Query' } & {
  selectCategoryById?: Maybe<
    { __typename?: 'Category' } & Pick<
      Category,
      'categoryId' | 'categoryName' | 'commodityTypeId' | 'commodityTypeName' | 'ordering'
    >
  >
  selectVarietyByCategoryId?: Maybe<
    Array<Maybe<{ __typename?: 'Variety' } & Pick<Variety, 'varietyId' | 'varietyName'>>>
  >
  selectPlaceByCategoryId?: Maybe<Array<Maybe<{ __typename?: 'Place' } & Pick<Place, 'placeId' | 'placeName'>>>>
}

export const GetCategorDetailDocument = gql`
  query getCategorDetail($categoryId: Int) {
...
/**
 * __useGetCategorDetailQuery__
 *
 * To run a query within a React component, call `useGetCategorDetailQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetCategorDetailQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetCategorDetailQuery({
 *   variables: {
 *      categoryId: // value for 'categoryId'
 *   },
 * });
 */
export function useGetCategorDetailQuery(
  baseOptions?: Apollo.QueryHookOptions<GetCategorDetailQuery, GetCategorDetailQueryVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useQuery<GetCategorDetailQuery, GetCategorDetailQueryVariables>(GetCategorDetailDocument, options)
}
export function useGetCategorDetailLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<GetCategorDetailQuery, GetCategorDetailQueryVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useLazyQuery<GetCategorDetailQuery, GetCategorDetailQueryVariables>(GetCategorDetailDocument, options)
}
export type GetCategorDetailQueryHookResult = ReturnType<typeof useGetCategorDetailQuery>
export type GetCategorDetailLazyQueryHookResult = ReturnType<typeof useGetCategorDetailLazyQuery>
export type GetCategorDetailQueryResult = Apollo.QueryResult<GetCategorDetailQuery, GetCategorDetailQueryVariables>
