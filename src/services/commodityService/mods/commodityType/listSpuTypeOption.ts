 ...
 */
export const listSpuTypeOption = (params: ListSpuTypeOptionParams, headers?: any) => {
  return request.request<defs.commodityService.ApiResult<Array<defs.commodityService.Option<string, number>>>>({
    ...request.buildOptions('/api/commodity/v1/spu/type/option', params, 'GET'),
    headers,
  });
};
 ...
 */
export const USE_LIST_SPU_TYPE_OPTION_KEY = '/api/commodity/v1/spu/type/option_GET';
