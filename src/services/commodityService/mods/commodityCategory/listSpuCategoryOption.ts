 ...
 */
export const listSpuCategoryOption = (params: ListSpuCategoryOptionParams, headers?: any) => {
  return request.request<defs.commodityService.ApiResult<Array<defs.commodityService.Option<string, number>>>>({
    ...request.buildOptions('/api/commodity/v1/spu/category/{id}/option', params, 'GET'),
    headers,
  });
};
 ...
 */
export const USE_LIST_SPU_CATEGORY_OPTION_KEY = '/api/commodity/v1/spu/category/{id}/option_GET';
