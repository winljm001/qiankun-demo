...
class SaveCommodityBomIngredientDTO {
  /** 商品分类id */
  commodityCategoryId = undefined
...
class SaveCommodityDTO {
  /** 配料列表 */
  commodityBomIngredientDTOS = []
