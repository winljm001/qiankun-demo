...
declare namespace API {
  export namespace commodityService {
    ...
    export namespace commodityCategory {
       ...
       * /api/commodity/v1/spu/category/list
       */
      export namespace listSpuCategoryOption {
        export class Params {}

        export type Response = defs.commodityService.ApiResult<
          Array<defs.commodityService.CommodityCategoryVO>
        >
        export const init: Response
        export function request(
          params: Params
       ...
       * /api/commodity/v1/spu/category/origin/{id}
       */
       ...
       * /api/commodity/v1/spu/category/variety/{id}
       */
    ...
    export namespace commodityType {
      ...
      export namespace listSpuTypeOption {
        ...
        export type Response = defs.commodityService.ApiResult<
          defs.commodityService.Option
        >
        export const init: Response
        export function request(
          params: Params
        ): Promise<
          defs.commodityService.ApiResult<defs.commodityService.Option>
        >
      }
    }
