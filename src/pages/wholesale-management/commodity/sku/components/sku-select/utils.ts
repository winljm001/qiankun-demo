...
import { PeachNotChosenSkuOptionQuery } from '@/graphql/operations/wholesale-management/__generated__/commodity'
...
export const getAllSpecDescartes = (
  ...
  selectedSpecOptions: PeachNotChosenSkuOptionQuery['peachNotChosenSkuOption'],
) => {
